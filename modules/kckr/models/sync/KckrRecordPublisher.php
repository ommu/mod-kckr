 ...
 * @created date 23 September 2016, 06:50 WIB
 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "tbperekam".
 *
 * The followings are the available columns in table 'tbperekam':
 ...
 * @property Tbkrekam[] $tbkrekams
 * @property Tbkota $kodekota0
 */
class KckrRecordPublisher extends CActiveRecord
{
	 ...
	 * @return KckrRecordPublisher the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('perekam, alamat', 'length', 'max'=>200),
			array('telepon', 'length', 'max'=>20),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('kodeperekam, perekam, kodekota, alamat, telepon', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'tbkrekams_relation' => array(self::HAS_MANY, 'Tbkrekam', 'kodeperekam'),
			'kodekota0_relation' => array(self::BELONGS_TO, 'Tbkota', 'kodekota'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'perekam' => Yii::t('attribute', 'Perekam'),
	...
	public function search()
	{
		...
		$criteria->compare('t.perekam',strtolower($this->perekam),true);
		...
		if(!isset($_GET['KckrRecordPublisher_sort']))
			$criteria->order = 't.kodeperekam DESC';

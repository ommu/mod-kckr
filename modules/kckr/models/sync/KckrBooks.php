 ...
 * @created date 23 September 2016, 06:52 WIB
 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "tbkcetak".
 *
 * The followings are the available columns in table 'tbkcetak':
 ...
 * @property Tbpenerbit $kodepenerbit0
 */
class KckrBooks extends CActiveRecord
{
	 ...
	 * @return KckrBooks the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('kodepenerbit', 'numerical', 'integerOnly'=>true),
			...
			array('idsurat, kodepenerbit, nosurat, tglkirimpos, tglkirimls, tglterima, ucapan, cekucapan', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		if(isset($_GET['kodepenerbit']))
			$criteria->compare('t.kodepenerbit',$_GET['kodepenerbit']);
		else

...
class MediaController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = KckrMedia::model()->findByPk(1,array(
		...
		$dataProvider = new CActiveDataProvider('KckrMedia', array(
			'criteria'=>$criteria,
			'pagination'=>array(
				'pageSize'=>10,
			),
		...
		$this->pageTitle = Yii::t('phrase', 'Kckr Medias');
	...
	public function actionAdd() 
	{
		...
		if(isset($_POST['KckrMedia'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'KckrMedia success created.'));
	...
	public function actionEdit($id) 
	{
		...
		if(isset($_POST['KckrMedia'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'KckrMedia success updated.'));
					//$this->redirect(array('view','id'=>$model->media_id));
					$this->redirect(array('manage'));
				}
			}

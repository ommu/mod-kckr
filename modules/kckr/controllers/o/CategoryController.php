...
class CategoryController extends Controller
{
	...
	public function actionAdd() 
	{
		...
		if(isset($_POST['KckrCategory'])) {
			$model->attributes=$_POST['KckrCategory'];
	...
	public function actionRunAction() {
		...
		if(count($id) > 0) {
			...
			if($actions == 'publish') {
				KckrCategory::model()->updateAll(array(
					'publish' => 1,
				),$criteria);
				...
				KckrCategory::model()->deleteAll($criteria);
			}
		}
	...
	{
		$model = KckrCategory::model()->findByPk($id);
		if($model===null)
			throw new CHttpException(404, Yii::t('phrase', 'The requested page does not exist.'));
		return $model;
	}
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='kckr-category-form') {

 ...
 *
 * KckrPublisherObligation represents the model behind the search form about `ommu\kckr\models\KckrPublisherObligation`.
 *
...
use ommu\kckr\models\KckrPublisherObligation as KckrPublisherObligationModel;

class KckrPublisherObligation extends KckrPublisherObligationModel
{
	/**
	 * {@inheritdoc}
	 */

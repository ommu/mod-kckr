 ...
 * KckrCategory
 *
 * KckrCategory represents the model behind the search form about `ommu\kckr\models\KckrCategory`.
 *
...
use ommu\kckr\models\KckrCategory as KckrCategoryModel;

class KckrCategory extends KckrCategoryModel
{
	/**
	 * {@inheritdoc}
	 */
	public function rules()
	{
		return [
			...
			[['category_type', 'category_code', 'creation_date', 'modified_date', 'updated_date', 'category_name_i', 'category_desc_i', 'creationDisplayname', 'modifiedDisplayname'], 'safe'],
		];
	}
	...
	public function search($params, $column=null)
	{
		...
		$query->andFilterWhere([
			...
			't.category_type' => $this->category_type,
		...
		$query->andFilterWhere(['like', 't.category_code', $this->category_code])

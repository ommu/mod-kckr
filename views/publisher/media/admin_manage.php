 ...
 * @var $searchModel ommu\kckr\models\search\KckrMedia
 *
...
if ($kckr != null) {
	$this->params['menu']['content'] = [
		['label' => Yii::t('app', 'Add Media'), 'url' => Url::to(['create', 'id' => $kckr->id]), 'icon' => 'plus-square', 'htmlOptions' => ['class' => 'btn btn-success modal-btn']],
		['label' => Yii::t('app', 'Import'), 'url' => Url::to(['import', 'id' => $kckr->id]), 'icon' => 'plus-square', 'htmlOptions' => ['class' => 'btn btn-default modal-btn']],
	];
}

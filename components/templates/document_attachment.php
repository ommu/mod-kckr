...
<page backtop="15mm" backbottom="15mm" backleft="25mm" backright="25mm" style="font-size: 12pt">
<div style="position: relative;">
	<table class="attachment" style="width: 100%;">
		...
		<tr <?php echo $i%2 == 0 ? 'class="even"' : '';?>>
			...
			<td class="center" style="vertical-align: middle; width: 90px;"><?php echo $val->kckr->send_type != '' ? ($val->kckr->send_type == 'pos' ? 'POS<br/>' : 'Langsung<br/>') : '';?><?php echo Yii::$app->formatter->asDate($val->kckr->send_date, 'long');?></td>

...
class PublisherController extends Controller
{
	...
	/**
	 * Lists all KckrPublisher models.
	 * @return mixed
	 */
	public function actionManage()
	{
        $searchModel = new KckrPublisherSearch();
		...
		$this->view->title = Yii::t('app', 'Publishers');
	...
	/**
	 * Creates a new KckrPublisher model.
	 * If creation is successful, the browser will be redirected to the 'view' page.
	 * @return mixed
	 */
	public function actionCreate()
	{
        $model = new KckrPublisher();
	...
	/**
	 * Updates an existing KckrPublisher model.
	...
	/**
	 * Displays a single KckrPublisher model.
	 * @param integer $id
	 * @return mixed
	 */
	public function actionView($id)
	{
		...
		$this->view->title = Yii::t('app', 'Detail Publisher: {publisher-name}', ['publisher-name' => $model->publisher_name]);
		$this->view->description = '';
		$this->view->keywords = '';
	...
	/**
	 * Deletes an existing KckrPublisher model.
	...
	public function actionDelete($id)
	{
        ...
        if ($model->save(false, ['publish', 'modified_id'])) {
			Yii::$app->session->setFlash('success', Yii::t('app', 'Kckr publisher success deleted.'));
			return $this->redirect(Yii::$app->request->referrer ?: ['manage']);
		}
	}

	/**
	 * actionPublish an existing KckrPublisher model.
	...
	/**
	 * Finds the KckrPublisher model based on its primary key value.
	 * If the model is not found, a 404 HTTP exception will be thrown.
	 * @param integer $id
	 * @return KckrPublisher the loaded model
	 * @throws NotFoundHttpException if the model cannot be found
	 */
	protected function findModel($id)
	{
        if (($model = KckrPublisher::findOne($id)) !== null) {
            return $model;
        }
